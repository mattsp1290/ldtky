...
proc parseAutoRuleDef(node: JsonNode): AutoRuleDef =
  ...
  result.alpha          = getField[float](node, "alpha")
  ...
  result.xOffset        = getField[int](node, "xOffset")
  result.yModulo        = getField[int](node, "yModulo")
  result.yOffset        = getField[int](node, "yOffset")
  result.tileRandomXMax = getField[int](node, "tileRandomXMax")
  result.tileRandomXMin = getField[int](node, "tileRandomXMin")
  result.tileRandomYMax = getField[int](node, "tileRandomYMax")
  result.tileRandomYMin = getField[int](node, "tileRandomYMin")
  result.tileXOffset    = getField[int](node, "tileXOffset")
  result.tileYOffset    = getField[int](node, "tileYOffset")
...
proc parseAutoLayerRuleGroup(node: JsonNode): AutoLayerRuleGroup =
  ...
  result.usesWizard       = getField[bool](node, "usesWizard")
